...
\begin{frame}{Summary \textbf{TODO}}
    \begin{itemize}
        ...
        \begin{itemize}
            \item computed flux, $k$-eigenvalue, temperature distribution in the slab
            \item compared to analytical formulas with norms,$C/E$ with $2-\sigma$ error bars, estimate pcm difference from analytical
        \end{itemize}
        \item Next steps include ...
        \begin{itemize}
            \item Simulation using NekRS for heat transfer.
...
\begin{frame}{Analytical Benchmark ODEs}
    \begin{itemize}
        ...
        \begin{multline}
            ...
            \left(\lambda - 1\right)\phi(x) = 0
            \QWITH \\
            \pm \frac{d\phi}{dx}\bigg|_{\pm \frac{L}{2}} + \Sigma_{t}\left(\pm \frac{L}{2}\right)
        \end{multline}
