...
\begin{frame}{Cardinal: A Modern Multiphysics Software}
    ...
    \end{figure}
    \begin{itemize}
        \item Cardinal \cite{novak2022-cardinal} wraps OpenMC \cite{openmc} and NekRS \cite{nekrs} into the MOOSE framework \cite{lindsay2022moose}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Cardinal: A Modern Multiphysics Software}
    ...
    \begin{figure}[H]
        \hspace*{0.85cm}
        \includegraphics[width=\linewidth]{figures/solid_fluid_coupling.png}
    \end{figure}
\end{frame}
...
\begin{frame}{System Domain, Differential Equations, and Boundary Conditions}
    ...
    \begin{figure}[T]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/1D_Benchmark_Diagram.png}<1->
    \end{figure}
    \begin{itemize}
        ...
        \end{equation}
        \item <3-> where $\lambda = (\frac{1}{k_{eff}}\frac{\nu \Sigma_{f}}{\Sigma_{t}} + \frac{\Sigma_{s}}{\Sigma_{t}} )$, $P$ is the slab power, and $L$ is the slab equilibrium length.
    \end{itemize}
\end{frame}
...
\begin{frame}{OpenMC Model}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item <10-> Mesh deformation is possible in Cardinal via DAGMC \cite{novak-2023}, but this was not available at the time of this work.
...
\begin{frame}{Individual Flux $C/E$ with $2\sigma$ Error Bars for Fine Cases}
    \begin{figure}[T]
        \centering
        \includegraphics[width=0.6\linewidth]{figures/1000_flux_CE_error_bars}
    \end{figure}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item <8-> eigenvalue pcm difference from analytical with $1\sigma$ uncertainty.
            \end{itemize}
            \item <9-> conclude verification of Cardinal's capability to model this 1-D coupled heat transfer and neutron transport benchmark.
        \end{itemize}
...
\begin{withoutheadline}
    \begin{frame}{Acknowledgements}
        \begin{itemize}
            ...
            % \item Regarding the second and third authors, this work was supported in part by Laboratory Directed Research and Development (LDRD) funding via UChicago Argonne, LLC, Operator of Argonne National Laboratory ("Argonne"). Argonne, a U.S. DOE Office of Science laboratory, is operated under Contract No. DE-AC02-06CH11357.
        \end{itemize}
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{figures/openmc_logo.png}
        \end{figure}
        \begin{figure}[H]
            \centering
...
\begin{frame}
    \frametitle{Why do the error bars appear on the same order despite cell refinement?}
        ...
        \end{figure}
        \begin{itemize}
            \item <2->MFP $\in[239,278]$ cm ($L=106.47$ cm). Spatially uniform birth distribution.
            \item <3->Nearly all points fall within $2\sigma$ (95\% Confidence Interval), meaning that Cardinal is computing the correct flux within statistical uncertainty.
        \end{itemize}
\end{frame}
