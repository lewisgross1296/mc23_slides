...
\begin{frame}{Modern Multiphysics Simulation and the Importance of V\&V}
    \pause
    \begin{itemize}
        \item <2-> Many new emerging multiphysics tools.
...
\begin{withoutheadline}
    \begin{frame}{Questions?}
        \begin{itemize}
            \item OpenMC website: {\tt \color{cyan}https://openmc.org/}
            \item OpenMC repository: {\tt\color{cyan} https://github.com/openmc-dev/openmc}
            \item Cardinal website: {\tt \color{cyan}https://cardinal.cels.anl.gov}
            \item Cardinal repository: {\tt\color{cyan} https://github.com/neams-th-coe/cardinal.git}
            \item MOOSE website:{\tt \color{cyan}https://mooseframework.inl.gov/}
            \item MOOSE repository: {\tt\color{cyan} https://github.com/idaholab/moose}
        \end{itemize}
    \end{frame}
\end{withoutheadline}
